...
namespace Tuckfirtle.Core.Network.P2P {
    ...
    static PacketReflection() {
      ...
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::Tuckfirtle.Core.Network.P2P.Packet), global::Tuckfirtle.Core.Network.P2P.Packet.Parser, new[]{ "PacketNetwork", "PacketKeepAliveDuration", "PacketCompressionType", "PacketEncryptionType", "PacketType", "PacketData" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    private global::Tuckfirtle.Core.Network.P2P.Header.PacketCompressionType packetCompressionType_ = global::Tuckfirtle.Core.Network.P2P.Header.PacketCompressionType.None;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    ...
    private global::Tuckfirtle.Core.Network.P2P.Header.PacketEncryptionType packetEncryptionType_ = global::Tuckfirtle.Core.Network.P2P.Header.PacketEncryptionType.None;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    ...
    private global::Tuckfirtle.Core.Network.P2P.Header.PacketType packetType_ = global::Tuckfirtle.Core.Network.P2P.Header.PacketType.Unknown;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    ...
    public override int GetHashCode() {
      ...
      if (PacketCompressionType != global::Tuckfirtle.Core.Network.P2P.Header.PacketCompressionType.None) hash ^= PacketCompressionType.GetHashCode();
      if (PacketEncryptionType != global::Tuckfirtle.Core.Network.P2P.Header.PacketEncryptionType.None) hash ^= PacketEncryptionType.GetHashCode();
      if (PacketType != global::Tuckfirtle.Core.Network.P2P.Header.PacketType.Unknown) hash ^= PacketType.GetHashCode();
    ...
    public void MergeFrom(Packet other) {
      ...
      if (other.PacketCompressionType != global::Tuckfirtle.Core.Network.P2P.Header.PacketCompressionType.None) {
        PacketCompressionType = other.PacketCompressionType;
      }
      if (other.PacketEncryptionType != global::Tuckfirtle.Core.Network.P2P.Header.PacketEncryptionType.None) {
        PacketEncryptionType = other.PacketEncryptionType;
      }
      if (other.PacketType != global::Tuckfirtle.Core.Network.P2P.Header.PacketType.Unknown) {
